...
import com.velto.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UserNotFoundException.class, RideNotFoundException.class, ResourceNotFoundException.class, NoResourceFoundException.class})
